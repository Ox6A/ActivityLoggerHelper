...
async def activity(interaction: discord.Interaction, steamid: str):
    ...
    if debugMode == True:
        ...
        if debuggingUserAllowed == False:
            embed1 = discord.Embed(title="Debugging Mode", description="The bot is currently in a debuggging mode for testing or maintenance. Sorry for the inconvenience!", color=0xFF0000)
            await interaction.response.send_message(embed=embed1, ephemeral=True)
            return
    ...
    if ChannelObj:
        ...
        embed1 = discord.Embed(title="Channel not found", description="The logging channel was not found. This is likely a configuration error, or the result of changes to the logging channels. Please contact `teasippingbrit` on Discord.", color=0xFF0000)
        await interaction.response.send_message(embed=embed1, ephemeral=True)
    ...
    try:
        ...
        try:
            with open("config.json", "w") as f:
                config = {"channelid":{"pd":1090365529564385310,"rpu":1141061367730806906,"sco":1081600560060444885,"nca":1079508453241917653,"nca_undercover":1158378499313246248,"nhs":1117803842646585424,"rs":1100029126758375485,"t":1210141399878737920,"test":1269777958860492883},"guilds":{"pd":472520717515096078,"rpu":472520717515096078,"sco":472534240576143401,"nca":473075559409385472,"nca_undercover":473075559409385472,"nhs":472537475605069825,"rs":472897608759771146,"t":472715289516048385,"test":1264515893610680393},"enabled_dept":["test","pd"],"minimum_role_requirement":{"pd":1179100367083016233,"rpu":0,"sco":811699338253172736,"nca":1241570118014599278,"nca_undercover":0,"nhs":752960738544451715,"rs":752961417606332506,"t":752961594194919478,"test":1272168995419717713},"debug_users":["743066712810717295"],"debug":False}
                json.dump(config, f)
            return True
